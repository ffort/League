...
ActiveRecord::Schema.define(version: 20150521184929) do

  create_table "abilities", force: :cascade do |t|
    t.string   "active",       limit: 255
    t.string   "passive",      limit: 255
    t.integer  "cooldown",     limit: 4
    ...
    t.string   "ability_type", limit: 15
  end
  ...
  create_table "champions", force: :cascade do |t|
    t.string   "champion_name",  limit: 255
    t.string   "primary_role",   limit: 255
    t.string   "secondary_role", limit: 255, default: ""
